      ...
      <div className='home-container'>
        <div className='list-item-container'>
          ...
          <div style={{ marginTop: '10px' }}>
            <Button shape='round' className='topic-channel-button' onClick={() => handleGetTopicList({ showAll: true })}>All of topic</Button>
          ...
          <div>
            {userInfo.userName ? <div className='user-info-container'>
              ...
              <div className='user-info-container--right'>
                ...
                <div>
                  <Button onClick={() => handleGetTopicList({ type: 'My post' })} style={{ padding: 0, paddingLeft: '10px' }} type='link'>My post</Button>
                  <Button onClick={() => handleGetTopicList({ type: 'My category' })} type='link'>My category</Button>
                </div>
              </div>
            </div> : ' '}
          </div>
